  ...
  return (
    <ul className="list-none max-w-6xl mx-auto grid grid-cols-3 gap-5">
      {notes === null ? (
        ...
        notes?.map((note) => (
          <li className="border m-4 p-4 rounded-lg shadow-[5px_3px_0px_1px_rgba(0,0,0,0.3)] shadow-blue-400 hover:shadow-[5px_8px_5px_rgba(0,0,0,0.3)] hover:shadow-blue-400 hover:translate-y-2 transition-transform ease-in">
